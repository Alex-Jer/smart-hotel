      ...
      <aside x-transition:enter="transition transform duration-300"
        ...
        class="fixed inset-y-0 z-10 flex flex-col flex-shrink-0 w-64 max-h-screen overflow-hidden transition-all transform bg-white border-r shadow-lg dark:bg-darker dark:border-dark lg:z-auto lg:static lg:shadow-none"
        ...
        <nav class="flex-1 overflow-hidden hover:overflow-y-auto">
          <ul class="p-2 overflow-hidden">
            <li>
              <a href="dashboard" class="flex items-center p-2 space-x-2 rounded-md hover:bg-gray-100"
            ...
            <li>
              <a href="history" class="flex items-center p-2 space-x-2 rounded-md hover:bg-gray-100"
                :class="{'justify-center': !isSidebarOpen}">
                <span>
