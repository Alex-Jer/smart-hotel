  ...
  <form action="" method="post">
    <div class="flex flex-col justify-center min-h-screen sm:py-12">
      <div class="p-10 mx-auto xs:p-0 md:w-full md:max-w-md">
        <?php
        if ($login == "failed") {
          echo "<div id='divAlerta' class='bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded' role='alert'>
        ...
        <div class="w-full bg-white divide-y divide-gray-200 rounded-lg shadow">
          <div class="px-5 py-7">
            ...
            <input type="text" id="inUsername" class="w-full px-3 py-2 mt-1 mb-5 text-sm border rounded-lg" name="username" required />
            ...
            <input type="submit" value="Login" class="transition duration-200 bg-blue-500 hover:bg-blue-600 focus:bg-blue-700 focus:shadow-sm focus:ring-4 focus:ring-blue-500 focus:ring-opacity-50 text-white w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-semibold text-center inline-block"></input>
          </div>
        </div>
      </div>
    </div>
